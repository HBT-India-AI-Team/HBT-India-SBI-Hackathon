  ...
  return (
    <PhoneScreen>
      <div className="flex flex-col items-center text-center gap-5 mt-16">
        ...
        <h1 className="font-heading font-bold text-2xl text-primary">Application submitted!</h1>
        <p className="text-on-surface-variant text-[14.5px] max-w-xs">
          Thanks — we're reviewing your details now. This usually takes just a few seconds in this demo (1-2
