...
export default function VoiceMessageBubble({
  ...
  variant = 'default',
  autoPlay = false,
  provider, // 'sarvam' | 'local' | null -- which provider actually handled STT (inbound) / TTS (outbound) for this message; null when not applicable (e.g. server-side echo reply with no provider info)
}) {
